...
// The outline redraws on hover, the same "it's being established" read the
// plug icon gives the Integrations row.
    ...
    return (
      ...
      >
        ...
        >
          <motion.path
            animate={controls}
            d="M17.5 19a4.5 4.5 0 1 0-1.4-8.8A6 6 0 1 0 6.3 19Z"
            initial="normal"
